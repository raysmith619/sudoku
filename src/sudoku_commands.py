...
sC = None               # Global reference, set by CommandFile
class SudokuCommands:
    ...
    def __init__(self, command_stream, play_control=None, debugging=False):
        ...
        """
        global sC                       # Static link to dots commands
        ...
        self.new_file = True
        self.reset()
        sC = self                       # set link to dots commands
    ...
    def ck(self, *args, **kwargs):
        ...
        """
        if sC is None or not hasattr(sC, "command_stream"):
        ...
        if self.play_control is None and not self.is_debugging():
            raise SelectError("SudokuCommands play_control link is missing")
    ...
    def set_debugging(self, debugging = True):
        ...
        """
        self.debugging = debugging
        SudokuCommands.play_control = None    # Suppress ck eror
...
def lg(*args, **kwargs):
    return sC.lg(*args, **kwargs)

def select(*args, **kwargs):
    return sC.select(*args, **kwargs)

def set_playing(*args, **kwargs):
    return sC.set_playing(*args, **kwargs)

def set_player(*args, **kwargs):
    return sC.set_player(*args, **kwargs)
